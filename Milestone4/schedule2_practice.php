    ...
    <div class="navigation">
      ...
      <div class="wrapper2">
        ...
        <?php
          ...
          $retrieve_req_query = "SELECT requirement FROM major_requirements WHERE major_id = $major_id";
          $req_result = mysqli_query($con, $retrieve_req_query);
          $counter = 1;
          $checkboxes[0] = "<br><br>";
          while ($row = $req_result->fetch_assoc()){
            //echo $row['requirement']."<br>";
            
            $checkboxes[$counter] = "<input type='checkbox'>".$row['requirement']."<br>";
            $counter++;
          }
